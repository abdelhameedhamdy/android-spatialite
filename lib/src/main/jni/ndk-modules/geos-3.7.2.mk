...
# run from within this directory (i.e. where this Android.mk file is located)
# find geos/ -name "*.cpp" | grep -Ev "tests|doc" | sort | awk '{ print "\t###"$1" \\" }' | sed 's/###geos/$(GEOS_PATH)/'
# include $(LOCAL_PATH)/../shared-vars.mk
# -------------------
# As of 2019-05-02
# -------------------
# Excluded files:
...
include $(CLEAR_VARS)
LOCAL_MODULE := geos
LOCAL_C_INCLUDES := $(LOCAL_PATH)/$(GEOS_PATH)/include

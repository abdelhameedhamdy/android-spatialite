...
LOCAL_C_INCLUDES := \
 ...
 $(LOCAL_PATH)/$(LZMA_PATH)/src/liblzma/common \
 $(LOCAL_PATH)/$(LZMA_PATH)/src/liblzma/delta \
 $(LOCAL_PATH)/$(LZMA_PATH)/src/liblzma/lz \
 $(LOCAL_PATH)/$(LZMA_PATH)/src/liblzma/lzma \
 $(LOCAL_PATH)/$(LZMA_PATH)/src/liblzma/rangecoder \
 $(LOCAL_PATH)/$(LZMA_PATH)/src/liblzma/simple \
 $(LOCAL_PATH)/$(LZMA_PATH)
LOCAL_SRC_FILES := \
